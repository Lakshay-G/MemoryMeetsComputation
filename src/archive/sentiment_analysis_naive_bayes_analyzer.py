...
def textblob_score(text: str):
    ...
    textblob_sentiment = TextBlob(text, analyzer=NaiveBayesAnalyzer())
    score_pos = textblob_sentiment.sentiment.p_pos
    score_neg = textblob_sentiment.sentiment.p_neg
    score_polarity = score_pos - score_neg
    score_subjectivity = 0
    # print(score_polarity, score_subjectivity, )
    # exit()
    return score_polarity, score_subjectivity
